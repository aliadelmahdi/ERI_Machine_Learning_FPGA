`ifndef SYS_DEFINES_SVH
`define SYS_DEFINES_SVH
    ...
    `define enable_constraint(constraint) \
            sis_seq_item.constraint.constraint_mode(`ON);
    `define disable_constraints  \
            sis_seq_item.constraint_mode(`OFF);
    `define enable_constraints  \
            sis_seq_item.constraint_mode(`ON);
    `define disable_constraint(constraint) \
            sis_seq_item.constraint.constraint_mode(`OFF);

`endif // SYS_DEFINES_SVH
